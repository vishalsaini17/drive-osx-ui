      ...
      <div className="flex-1 p-6 overflow-y-auto custom-scrollbar">
        {deletedFiles.length === 0 ? (
          ...
          <div className="space-y-4 animate-fadeIn">
            ...
            {/* Diagnostic reclaimed total */}
            <div className={`text-right ${ts.reclaimText}`}>
              Total Space Reclaimed: <span className={ts.reclaimSize}>{calculateTotalSizeKB().toFixed(1)} KB</span>
            </div>
          </div>
        )}
      </div>
