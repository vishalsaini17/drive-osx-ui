...
import {
  X, Phone, Video, Star, Eraser, LogOut, Flag, Pencil, UserPlus, Trash2, Loader2,
  ImageOff, FileText, Users, Check,
} from 'lucide-react';
import type { Conversation, MediaItem } from '../../platform/messaging/MessagingService';
        ...
        <div className="p-3">
          ...
          {isLoadingMedia ? (
            ...
            <div className="flex flex-col items-center gap-2 py-6 text-center">
              ...
              <p className={`text-[11px] ${palette.textMuted}`}>Nothing shared yet.</p>
            </div>
          ) : (
