...
interface SidebarPanelProps {
  ...
  /** Fill an overlay drawer instead of taking the fixed inline width. */
  fill?: boolean;
}
 ...
 */
export default function SidebarPanel({ dataName, title, actions, children, fill = false }: SidebarPanelProps) {
  return (
    <div data-name={dataName} className={`${fill ? 'w-full flex-1 min-h-0' : 'w-60 shrink-0 border-r'} border-[var(--wb-border-strong)] bg-[var(--wb-surface-raised)] flex flex-col overflow-hidden`}>
